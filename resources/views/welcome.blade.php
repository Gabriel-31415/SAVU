...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        {{-- <nav class="flex justify-between bg-white p-2">
            <div >
                <img style="vertical-align:middle;display:inline;" src="{{  URL::to('/').'/imagem/brasil.png' }}" height="30" width="30" alt="Bandeira do Brasil" srcset="">
                <div style="vertical-align:middle; display:inline;">
                    BRASIL
                </div> 
            </div>
            <div>CORONAVÍRUS (COVID-19)</div>
            <div>Simplifique</div>
            <div>Participe</div>
            <div>Acesso às Informações</div>
            <div>Legislação</div>
            <div>Canais</div>
            <div>
                <img src="{{  URL::to('/').'/imagem/acessibilidade.png' }}" height="30" width="30" alt="Bandeira do Brasil" srcset="">
            </div>
        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            @if (Route::has('login'))
                <div class="sm:fixed mt-6 pt-10 sm:top-0 sm:right-0 p-6 text-right z-10">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Tela Inicial</a>
                    @else
